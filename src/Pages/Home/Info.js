...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 mx-12 mb-6'>
            ...
            <InfoCard bgClass="bg-accent" cardInfo="Brooklyn, NY 10036, United States" cardTitle="Visit our location" className img={marker}></InfoCard>
